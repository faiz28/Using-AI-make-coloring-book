...
# cv.imread function, in below method,
import os
...
png = 'F:\\Faiz important project\\practice\\output\\'
...
for path in os.listdir(dir_path):
    ...
    if os.path.isfile(os.path.join(dir_path, path)):
        ...
        # kernel2 = np.ones((5, 5), np.float32) / 21

        # th1 = cv.filter2D(src=th1, ddepth=-1, kernel=kernel)
...
# #         cv.line(mask, (x_mid0, y_mid0), (x_mid1, y_mi1), 255,    
# #         thickness)
